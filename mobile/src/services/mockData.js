...
export const DEMO_ACTIVITIES = [
  {
    ...
    title: 'Expense added',
    description: 'Alex added "Monthly Rent" — $2,400.00',
    user: DEMO_USER,
  ...
  },
  {
    ...
    description: 'Jamie completed "Buy groceries"',
    user: MEMBER_2,
  ...
  },
  {
    ...
    icon: 'receipt-outline',
    title: 'Expense added',
    description: 'Jamie added "Grocery Run" — $156.80',
    user: MEMBER_2,
  ...
  },
  {
    ...
    icon: 'people-outline',
    title: 'Group created',
    description: 'Alex created the group "The Dream Team"',
    user: DEMO_USER,
  ...
  },
  {
    ...
    icon: 'receipt-outline',
    title: 'Expense added',
    description: 'Alex added "Electricity Bill" — $134.50',
    user: DEMO_USER,
  ...
  },
  {
    ...
    description: 'Alex assigned "Take out trash" to themselves',
    user: DEMO_USER,
  ...
  },
  {
    ...
    title: 'Message sent',
    description: 'Sam sent a message in group chat',
    user: MEMBER_3,
  ...
  },
  {
    ...
    title: 'Friend joined',
    description: 'Sam Rivera joined the group',
    user: MEMBER_3,
